...
const Hero = () => {
  return (
    <>
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Kami menyediakan layanan transportasi untuk memudahkan anda berkeliling pulau lombok yang sangat indah ini, anda dapat menemukan berbagai layanan kami mulai dari penyewaan mobil, motor atau paket destinasi wisata.
            </p>
      ...
      <div className="relative overflow-hidden bg-cover bg-no-repeat bg-[url('../public/img/bg-beach.jpg')]" style={{backgroundPosition: "50%", height: "640px"}}>
          <div
            ...
            <div className="flex h-full items-center justify-center">
              <div className="px-6 text-center text-white md:px-12">
                <h1 className="mt-2 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl">
                  Dong Ayok <br /><span>ke Lombok!</span>
                </h1>
                <button type="button"
